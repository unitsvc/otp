...
[![PkgGoDev](https://pkg.go.dev/badge/github.com/unitsvc/otp)](https://pkg.go.dev/github.com/unitsvc/otp) [![Build Status](https://travis-ci.org/unitsvc/otp.svg?branch=master)](https://travis-ci.org/unitsvc/otp)
...
Please [open issues in Github](https://github.com/unitsvc/otp/issues) for ideas, bugs, and general thoughts.  Pull requests are of course preferred :)
